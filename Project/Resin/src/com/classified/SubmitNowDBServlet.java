...
/**
 * SubmitNowDBServlet.java
 * This servlet works with LoginSubmitHandler.java, SubmitNow.jsp, 
 * LoginSubmitHandler.java and SubmitLogin.jsp
 * The way it works is, when the user does a SubmitNow.jsp the LoginSubmitHandler
 * checks to see if you are logged in. If you are logged in you can ad an ad. If
 * not you are redirected to the SubmitLogin.jsp page. Once you login properly
 * you are redirected back to the SubmitNow.jsp page.
 * 
...
public class SubmitNowDBServlet extends HttpServlet
{
    ...
    protected javax.sql.DataSource pool;
...
///////////////// EnD NEW      
 			System.out.println("SubmitNowDBServlet init: Getting a connection to - pool");
	...
	todaysDate = calendar1.getTime();
	 ...
	 // the server. Also check if their is a connection with the database.
			...
			if(done == null){
				...
				// Save the request URL as the true target and redirect to the SubmitLogin.jsp page.

				session.setAttribute("Slogin.target", "/SubmitNow.jsp");
				//session.putValue("Slogin.target",
				//		HttpUtils.getRequestURL(request).toString());
				response.sendRedirect(request.getScheme() + "://" +
							request.getServerName() + ":" + request.getServerPort() +
							"classified/SubmitLogin.jsp");
				return;
			}
   	...
   	if (action.equals("step1")){ 
        ...
        registerStatementAdInfo.setString(EMAIL_POSITION, email);
		    registerStatementAdInfo.setString(WEBSITE_POSITION, webSite);
				...
				htmlPage.append("<body background=../servletimages/newsbg.jpg bgcolor=ffffff>");
	      ...
	      outputToBrowser.close();
				...
				htmlPage.append("<body background=../servletimages/newsbg.jpg bgcolor=ff0000>");
				...
				htmlPage.append("<center><a href=../index.html>Return to Home Page</a>");
...
////////////////////////// UN-COMMENT UP TO HERE ONLY!
    ...
    registerStatementAdInfo.executeUpdate();
		...
		htmlPage.append("<FONT SIZE=\"1\"><a href=../SubmitNow.jsp>Click here if \"Back\" button does not work.</a></FONT>");
		...
		htmlPage.append("<hr>");
		htmlPage.append("<center><b><a href=../index.html>Click Here To Continue</a></b>");
    ...
    // now let's send this dynamic data
	  // back to the browser
		...
		return;
          ...
          System.out.println("Exceptiion in SubmitNowDBServlet...roolback" + ex);
      }
              ...
              if (dbConnection != null)
                try{ 
                  ...
                  dbConnection.close();   
                    ...
                    System.out.println("SubmitNowDBServlet SQL Error " + sqe);
                }			
      }
